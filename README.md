...
- Follow the prompt to install. The 💊 icon will now be in your app drawer/home screen.

How to use it:
- Open the app when you are loading the physical dosette box.
- Tap each medication as you drop it into the tray to check it off.
- When the whole box is full, hit the "Reset Checklist" button at the bottom so it's ready for the next person.

Note: If the 'Last Updated' date looks old, just pull down on the screen to refresh the page and get the latest list!
